...
export default function Home(props) {
    ...
    const {
        woopState: { active, isSignedIn, accountLocked, wikiExt }
    } = props
        ...
        <div className={route}>
            <section>
                <div className={bubble}>
                    ...
                    {
                        !wikiExt && <p>
                            No Woop compatible extension was detected.<br />
                    ...
                    {
                        wikiExt && accountLocked && <div>
                            <p>Your Math Wallet is locked.</p>
                            <ol>
                                <li>Unlock your Math Wallet using your password</li>
                                <li>Connect to the Woop Mainnet by clicking "Switch Network"</li>
