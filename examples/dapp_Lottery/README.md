...
### Install Woop SDK https://github.com/woop-chain/sdk  
```
...
const { TruffleProvider } = require('@woop-js/core')
//Local
...
```javascript
//LOCAL
//Local uses account woc103q7qe5t2505lypvltkqtddaef5tzfxwsse4z7 on Shard 0
...
//TESTNET
//Account: woc18t4yj4fuutj83uwqckkvxp9gfa0568uc48ggj7
...
TESTNET_0_URL='https://trpc.woopchain.com'
...
MAINNET_0_URL='https://rpc.woopchain.com'
